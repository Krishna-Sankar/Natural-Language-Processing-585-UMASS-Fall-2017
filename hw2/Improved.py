...
def train(examples, stepsize=1, numpasses=10, do_averaging=False, devdata=None):
    ...
    for pass_iteration in range(numpasses):
        ...
        with open('weights1.pickle', 'wb') as f:
...
def local_emission_features(t, tag, tokens):
    ...
    #Source for new features - Improvement HW2 585 NLP http://dictionary.cambridge.org/grammar/british-grammar/word-formation/suffixes
    #print "test-improvement"

    verb = ['ify', 'ate', 'en', 'ize', 'ise']
    noun = ['age', 'al', 'ance', 'ence', 'dom', 'ee', 'er', 'or', 'hood', 'ism', 'ist', 'ity', 'ty', 'ment', 'ness', 'ry', 'ship', 'sion', 'tion', 'xion']
    adjective = ['able', 'ible', 'al', 'en', 'ese', 'ful', 'i', 'ic', 'ish', 'ive', 'ian', 'less', 'ous', 'y']
    adverb = ['ly', 'ward', 'wards', 'wise']
    suffixes = noun + verb + adverb + adjective
